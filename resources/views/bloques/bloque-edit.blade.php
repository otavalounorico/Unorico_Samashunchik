...
<form method="POST" action="{{ route('bloques.update', $bloque) }}">
    ...
    <div class="modal-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                {{-- Lo ponemos readonly porque el select de abajo es el que manda --}}
            ...
            {{-- SELECCIÓN DEL CÓDIGO GIS --}}
            <div class="col-md-8">
                <label class="form-label fw-bold text-primary">Vincular con Código GIS</label>
                ...
                <small class="text-muted text-xs">Si cambias esto, el código del bloque se actualizará.</small>
            </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-warning">Actualizar Bloque</button>
    </div>
</form>